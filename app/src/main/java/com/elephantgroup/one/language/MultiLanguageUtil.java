package com.elephantgroup.one.language;
...
public class MultiLanguageUtil {
    ...
    private void setConfiguration() {
        ...
        Configuration configuration = MyApplication.mContext.getResources().getConfiguration();
    ...
    private Locale getLanguageLocale() {
        int languageType = SharedPrefsUtil.readInt(MyApplication.mContext,SharedPrefsUtil.FILE_APPLICATION,SharedPrefsUtil.KEY_SAVE_LANGUAGE);
    ...
    public void updateLanguage(int languageType,boolean writeSharedPrefs) {
        if (writeSharedPrefs){
            SharedPrefsUtil.writeInt(MyApplication.mContext,SharedPrefsUtil.FILE_APPLICATION,SharedPrefsUtil.KEY_SAVE_LANGUAGE,languageType);
        }
