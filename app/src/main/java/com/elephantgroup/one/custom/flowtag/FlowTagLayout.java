package com.elephantgroup.one.custom.flowtag;
...
public class FlowTagLayout extends ViewGroup {
            ...
            childView.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (mOnTagSelectListener != null) {
                        mOnTagSelectListener.onItemSelect(FlowTagLayout.this, (MnemonicBean) mAdapter.getItem(j));
                    }
                }
            });
        }
     ...
     */
    public void setAdapter(ListAdapter adapter, boolean isRemoveTag) {
